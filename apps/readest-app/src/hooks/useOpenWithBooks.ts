...
/**
 * Handle "Open with Moyue" file imports. Consumes the `app-incoming-url`
 ...
 *
 * Non-file URL shapes (https, moyue://, data:, blob:) are skipped here
 ...
 *
 *   `'VIEW'` with auto-import OFF (Android only — user picked Moyue from the
 ...
 *   syncs, which is what a "Send to Moyue" share (and an opt-in "Open
