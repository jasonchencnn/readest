    ...
    <div className='flex flex-col gap-3 pt-2'>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <span className='text-base-content/65 text-[0.85em] leading-relaxed'>
          {_(
            'Moyue re-scans these folders when it opens or returns to the foreground and imports any new books. Each folder keeps the structure it was imported with.',
          )}
        </span>
      </div>
