 ...
 * Converts between Moyue (foliate-js) CFI format and KOReader CREngine XPointer format
 */
...
export class XCFI {
   ...
   * against the real engine with apps/moyue.koplugin/scripts/xpointer-oracle.lua.
   */
  ...
  /**
   * Check if an element is injected by Moyue at runtime and should be
